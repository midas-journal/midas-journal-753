...
int main(int argc, char * argv[])
{
  ...
  typedef itk::ConchelloIntensityPenalizationImageFilter< FFTConvolutionType::InternalImageType > PenalizationType;
  PenalizationType::Pointer penal = PenalizationType::New();
  conv->SetSmoothingFilter( penal );
  // conv->SetSmoothingPeriod( 10 );
